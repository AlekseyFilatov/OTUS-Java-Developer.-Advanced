package otus.cqrses.cqrsesproj.adapters.filters;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import otus.cqrses.cqrsesproj.application.exceptions.AggregateNotFoundException;
import otus.cqrses.cqrsesproj.application.exceptions.EmployeeDocumentNotFoundException;
import otus.cqrses.cqrsesproj.application.exceptions.ExceptionResponseDTO;
import otus.cqrses.cqrsesproj.application.exceptions.InternalServerErrorResponse;
...
public class GlobalControllerAdvice {
    ...
    @ExceptionHandler({AggregateNotFoundException.class, EmployeeDocumentNotFoundException.class})
