...
import otus.cqrses.cqrsesproj.application.exceptions.SerializerRuntimeException;
...
public final class SerializerUtils {
    ...
    public static byte[] serializeToJsonBytes(final Object object) {
        try {
            ...
            throw new SerializerRuntimeException(e.getMessage(), e);
        }
    }
    ...
    public static Map<String, byte[]> deserializeEventsMetadata(final byte[] metaData) {
    ...
    public static byte[] serializeEventsMetadata(final Map<String, byte[]> metaData) {
        try {
